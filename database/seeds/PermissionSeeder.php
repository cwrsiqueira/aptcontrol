...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('permission_items')->insert([
            ...
            ['slug' => 'sellers.cc',     'name' => 'Conta Corrente (Vendedor)', 'group_name' => 'Vendedores', 'created_at' => $now, 'updated_at' => $now],
            ...
            // PRODUTOS PEDIDOS
            ['slug' => 'order_products.create',    'name' => 'Efetuar Pedido',               'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
            ['slug' => 'order_products.view',      'name' => 'Visualizar Pedido',            'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
            ['slug' => 'order_products.update',    'name' => 'Editar Pedido',                'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
            ['slug' => 'order_products.delete',    'name' => 'Excluir Pedido',               'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
            ['slug' => 'order_products.cc',        'name' => 'Conta Corrente (Pedido)',      'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
            ['slug' => 'order_products.delivery',  'name' => 'Concluir Pedido',              'group_name' => 'Pedidos',   'created_at' => $now, 'updated_at' => $now],
        ]);
