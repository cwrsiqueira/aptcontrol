                ...
                <form action="{{ route('clients.store') }}" method="post" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_category" id="id_category" class="form-control">
                            @foreach ($categories as $item)
                                <option @if (old('id_category') == $item->id) selected @endif value="{{ $item->id }}">
                                    {{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('contact') is-invalid @enderror" type="text" name="contact"
                            placeholder="Whatsapp, telefone etc..." id="contact" value="{{ old('contact') }}">
                    </div>

                    <div class="form-group">
                        <label for="full_address">Endereço completo:</label>
                        <textarea class="form-control" name="full_address" id="full_address" placeholder="Endereço completo">{{ old('full_address') }}</textarea>
                    </div>
