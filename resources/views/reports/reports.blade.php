    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg pt-3 px-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-lift">
                    <div class="card-header">
                        <h4 class="mb-0">Relação de Entregas Pendentes</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card card-lift">
                    <div class="card-header">
                        <h4 class="mb-0">Relação de Entregas Realizadas</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('report_delivery_byPeriod') }}" method="get">
                            ...
                            <small class="text-muted d-block mt-2">Gera a lista de entregas realizadas no período.</small>
                        </form>
                    </div>
                </div>
            </div>
