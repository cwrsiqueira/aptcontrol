    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg pt-3 px-4">
        ...
        <div>
            <div class="d-flex justify-content-between">
                ...
                <button @if(in_array('12', $user_permissions) || Auth::user()->is_admin) @else disabled title="Solicitar Acesso" @endif class="btn btn-secondary my-3" data-toggle="modal" data-target="#modal_addcliente">Cadastrar Cliente</button>

                @if(in_array('20', $user_permissions) || Auth::user()->is_admin) 
