    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg pt-3 px-4" style="height: 100vh;">
        ...
        <form action="{{ route('orders.store') }}" method="post" id="form">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th colspan="1">Data: <input class="form-control" type="date" name="order_date" id="order_date"
                                value="{{ old('order_date') ?? date('Y-m-d') }}" max="{{ date('Y-m-d') }}"></th>
                        <th colspan="5">Cliente: <input readonly class="form-control" type="text" name="client_name"
                                id="client_name" value="{{ $client->name }}"><input type="hidden" name="client_id"
                                id="client_id" value="{{ $client->id }}"></th>
                    </tr>
                    <tr>
                        <th colspan="1">Pedido Nr.: <input
                                class="form-control @error('order_number') is-invalid @enderror order_number" type="search"
                                name="order_number" value="{{ old('order_number') ?? $seq_order_number }}"
                        ...
                        <th colspan="2">Valor do Pedido: <input class="form-control" readonly type="text"
                                name="total_order" id="total_order" value="0"><small class="order_number_align_size"
                        ...
                        <th colspan="1" style="text-align: center">
                            <a class="add_line" style='display:none;' href='#' data-toggle='tooltip'
