...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg pt-3 px-4">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('trucks.store') }}" method="post" novalidate>
                    @csrf

                    <div class="form-group">
                        <label for="responsavel">Responsável *</label>
                        <input type="text" class="form-control @error('responsavel') is-invalid @enderror"
                            id="responsavel" name="responsavel" maxlength="150" required value="{{ old('responsavel') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('capacidade_paletes') is-invalid @enderror"
                            id="capacidade_paletes" name="capacidade_paletes" min="0" required value="{{ old('capacidade_paletes', 0) }}">
                    </div>

                    <div class="form-group">
                        <label for="modelo">Modelo</label>
                        <input type="text" class="form-control" id="modelo" name="modelo" maxlength="100" value="{{ old('modelo') }}">
                    </div>

                    <div class="form-group">
                        <label for="placa">Placa</label>
                        <input type="text" class="form-control" id="placa" name="placa" maxlength="20" value="{{ old('placa') }}">
                    </div>
