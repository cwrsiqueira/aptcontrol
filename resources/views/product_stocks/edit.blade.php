...
@section('title', 'Editar registro - Estoque - ' . $product->name)
...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg pt-3 px-4 mb-3">
        ...
        <div class="card bg-light">
            <div class="card-body">
                <form method="POST" action="{{ route('products.stocks.update', [$product->id, $stock->id]) }}">
                    @csrf
                    @method('PUT')

                    @include('product_stocks._form', ['stock' => $stock])
